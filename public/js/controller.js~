...
angular.
  ...
  controller('MainCtrl2', function ($scope) {
    ...
    $scope.photos = [
        ...
        {src: '/img/slider/sliders/zona/014.resized.jpg', descIT: 'Castello di Illasi', descFR: '', descEN: ''},
        {src: '/img/slider/sliders/zona/012.resized.jpg', descIT: 'Castello di Soave', descFR: '', descEN: ''},
        {src: '/img/slider/sliders/zona/019.resized.jpg', descIT: 'Castello di Soave', descFR: '', descEN: ''},
        {src: '/img/slider/sliders/zona/009.resized.jpg', descIT: 'Castello di Soave', descFR: '', descEN: ''},
        {src: '/img/slider/sliders/zona/002.resized.jpg', descIT: 'Ponte Pietra', descFR: '', descEN: ''},
        {src: '/img/slider/sliders/zona/016.resized.jpg', descIT: 'Ponte Pietra', descFR: '', descEN: ''},
        {src: '/img/slider/sliders/zona/017.resized.jpg', descIT: 'Ponte Pietra', descFR: '', descEN: ''},
        {src: '/img/slider/sliders/zona/021.resized.jpg', descIT: 'Ponte Pietra', descFR: '', descEN: ''},        
        {src: '/img/slider/sliders/zona/022.resized.jpg', descIT: 'Castelvecchio', descFR: '', descEN: ''},
        {src: '/img/slider/sliders/zona/003.resized.jpg', descIT: 'Castelvecchio', descFR: '', descEN: ''},        
        {src: '/img/slider/sliders/zona/006.resized.jpg', descIT: 'Piazza delle Erbe', descFR: '', descEN: ''},
        {src: '/img/slider/sliders/zona/020.resized.jpg', descIT: 'Teatro romano di Verona', descFR: '', descEN: ''},
        {src: '/img/slider/sliders/zona/007.resized.jpg', descIT: 'Porta Borsari', descFR: '', descEN: ''},
        {src: '/img/slider/sliders/zona/010.resized.jpg', descIT: 'Arena di Verona', descFR: '', descEN: ''},
        {src: '/img/slider/sliders/zona/011.resized.jpg', descIT: 'Bardolino - lago di Garda', descFR: '', descEN: ''},
        {src: '/img/slider/sliders/zona/013.resized.jpg', descIT: 'Bardolino - lago di Garda', descFR: '', descEN: ''}
    ];
